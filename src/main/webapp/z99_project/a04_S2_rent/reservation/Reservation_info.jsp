								...
								<ul>
									...
									<li>
										...
										<select id="storename" name="storename">
											...
											<option id="storename" value="제주 오토하우스1">제주 오토하우스1</option>
											<option id="storename" value="제주 오토하우스2">제주 오토하우스2</option>
											<option id="storename" value="제주 오토하우스3">제주 오토하우스3</option>
										</select>
