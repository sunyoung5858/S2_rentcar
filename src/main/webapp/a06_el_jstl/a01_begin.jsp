...
<%--
	...
	1. jsp에서 사용가능한 새로운 스크립트 언어
		...
		변수설정과 scope에 따른 처리를 하다보면 예외를 처리해야 하고,
		scriptlet의 복잡성에서 많은 에러가 발생할 가능성이 보였다.
...
<%
	...
	/*
	연습문제
	물건명, 가격, 갯수를 설정하고, el로 호출하여 아래 화면에서 출력하세요.
	*/
	pageContext.setAttribute("pname","연필");
	pageContext.setAttribute("price", 2500);
